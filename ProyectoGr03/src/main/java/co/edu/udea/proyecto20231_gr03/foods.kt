 ...
 * Use the [foods.newInstance] factory method to
...
class foods : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val imgBtn= view.findViewById<ImageView>(R.id.imageFood1)

        imgBtn.setOnClickListener {
            findNavController().navigate(R.id.action_foods_to_manage)
        }

        val btnRegister= view.findViewById<Button>(R.id.btnAddFood)
